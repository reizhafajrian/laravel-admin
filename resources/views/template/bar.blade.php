...
<body @yield("bodyclass")>
  <div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
    ...
    <ul class="c-sidebar-nav">
      ...
      <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/tambahmenu">
          <svg class="c-sidebar-nav-icon">
            <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-speedometer"></use>
          </svg>Tambah Menu<span class="badge badge-info"></span></a></li>
      <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="/createuser">
          <svg class="c-sidebar-nav-icon">
            <use xlink:href="vendors/@coreui/icons/svg/free.svg#cil-speedometer"></use>
          </svg>Tambah User<span class="badge badge-info"></span></a></li>
